        ...
        <main className="text-3xl">
          ...
          <div className="font-poppins p-4 text-black bg-white flex flex-col gap-4 pt-12 justify-center items-center">
            ...
            <p className="text-[16px] text-center max-w-[50rem]">
              Beehive Discreet Club was created for the community as a safe
              space for all. Please read through this set of house rules to make
            ...
            <div className="p-4 max-w-[60rem] justify-center rounded-md items-start flex text-[16px] w-full flex-col gap-4 bg-red-200">
              <p className="text-[15px] ">
                ...
                and respectful demeanor with the safety of all in mind.
              </p>
              <ul className="flex flex-col text-[15px] list-disc px-8">
                ...
                <li>
                  No performance-enhancing drugs (can lead to medical
                  emergencies)
                </li>
