  ...
  return (
    <MainLayout targetRef={targetRef}>
      <main className="text-3xl">
        ...
        <div
          id="about"
          className="font-poppins p-4 flex flex-col gap-4 pt-12 justify-center items-center"
        >
          ...
          <p className="text-sm">
            ...
            professional dominatrix and kink educator Head mistress Garcia after
            over 12 years working in the industry.
          </p>
          <p className="text-sm">
          ...
          <p className="text-sm">
            ...
            space, presenting our massive collection of hand-crafted BDSM toys,
            equipments and custom designed bondage furnitures in our various
            well designed play rooms many of which have been hand-crafted by
            local artisans .
          </p>
          <p className="text-sm">
